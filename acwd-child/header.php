...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-60860241-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());

	  gtag('config', 'UA-60860241-1');
	</script>
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-shrink p-md-0 " id="mainNav">
    <div class="container row align-items-center justify-content-lg-around mx-auto">
        ...
        <div class="social col-auto d-lg-flex justify-content-center pb-2 mt-2 mx-0 px-0 d-none">
            ...
            <a href="https://manehome.fr/contact/" class="btn btn-secondary">Contactez-nous</a>
        </div>
